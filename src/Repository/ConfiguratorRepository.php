...
/**
 * @extends ServiceEntityRepository<Configurator>
 *
...
class ConfiguratorRepository extends ServiceEntityRepository
{
    ...
    public function save(Configurator $entity, bool $flush = false): void
    {
    ...
    public function remove(Configurator $entity, bool $flush = false): void
    {
